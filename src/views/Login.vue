  ...
  <el-card class="card">
    ...
    >
      ...
      <el-form-item class="login_btn_box clearfix">
        <el-button @click="login()" class="login_btn" type="primary" :loading="loading">登陆</el-button>
      </el-form-item>
    </el-form>
  </el-card>
</template>
...
import {ref, reactive, defineComponent, getCurrentInstance, onMounted} from "vue";
...
export default defineComponent({
  ...
  setup(props,context){
    ...
    const request = async () => {
      ...
      console.log(data);*/
      loading.value=true
      proxy.$http.loginApi(loginform).then(v=>{
        console.log(v);
        loading.value=false
        if(v&&v.code == 200){
