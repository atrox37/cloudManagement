<template>
  <div class="setting-panel">
    ...
    <div>
      <el-button-group>
        <el-button size="small" type="primary" @click="$emit('saveFlow')">save</el-button>
        <el-button size="small" type="primary" @click="$emit('addFetchNode')">add</el-button>
      </el-button-group>
...
export default defineComponent({
  ...
  setup(props){
    const nodeD=toRef(props,'nodeData')
    console.log("--->"+nodeD.value)
    const title=ref('')
    watch(nodeD,value => {
      console.log('watch--->')
      title.value=value?value.text.value:''
    })
    ...
    return {title,styleConfig,nodeD}
  }
